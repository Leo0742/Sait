            ...
            <div className="grid lg:grid-cols-[1fr,400px] gap-12 items-start">
              <div className="text-white">
                <div className="flex items-center gap-2 text-sm mb-2">
                  ...
                  <span>17.06.2026 – 21.06.2026</span>
                </div>
                <div className="flex items-center gap-2 text-sm mb-8">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span>Россия, Красноярский край</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl">
                <img
                  src="https://ext.same-assets.com/252857205/1596549718.png"
                  alt="Бирюса 2026"
          ...
          <div className="grid lg:grid-cols-[1fr,380px] gap-12">
              ...
              <section className="mb-16">
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-gray-700">
                  <p>
                    ...
                    <strong>Всероссийская смена «Физическая культура и спорт» на «Бирюсе»</strong> объединит{' '}
                  ...
                  <p className="bg-[#FCF1F5] border-l-4 border-[#E55C94] p-6 rounded-lg mt-8">
                    <strong>В 2026 году «Бирюса» – 20 лет!</strong> Юбилейный сезон впитает всё лучшее, что было за эти годы. А ещё здесь есть вайб, который не передать словами: ты живёшь на территории, оторванной от большой земли, и полностью погружаешься в атмосферу образование и новых друзей.
                  </p>
            ...
            <div>
              <div className="bg-[#F5EDE7] rounded-2xl p-6 sticky top-6">
                ...
                <p className="text-sm mb-6">17.06.2026 – 21.06.2026</p>

                <h3 className="font-bold text-base mb-3">Даты регистрации</h3>
                <p className="text-sm mb-6">11.03.2026 – 17.04.2026</p>

                <h3 className="font-bold text-base mb-3">Регион</h3>
                <p className="text-sm mb-6">Россия, Красноярский край</p>
