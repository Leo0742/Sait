...
export default function DobrinoEventPage() {
  return (
        ...
        >
          <div className="max-w-[1400px] mx-auto px-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <Badge className="bg-gray-500 text-white border-none font-medium px-4 py-2 rounded-lg">
            ...
            <div className="grid lg:grid-cols-[1fr,400px] gap-12 items-start">
              <div className="text-white">
                ...
                <div className="flex items-center gap-2 text-sm mb-8">
                  ...
                  <span>Россия, Ханты-Мансийский автономный округ - Югра</span>
                </div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-8 leading-tight">
                  Всероссийский форум развития гражданского общества «Добрино»
                </h1>
                <p className="text-sm opacity-90">
                  Регистрация доступна только следующим категориям пользователей: иностранные участники, соотечественники (РФ граждане за рубежом), иностранные участники, проживающие на территории РФ.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl">
                <img
                  src="https://ext.same-assets.com/252857205/70379289.svg"
                  alt="Добрино 2026"
          ...
          <div className="grid lg:grid-cols-[1fr,380px] gap-12">
            ...
            <div>
              <section className="mb-16">
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-gray-700">
                  <p>
                    С 1 по 14 июля Ханты-Мансийский автономный округ - Югра станет площадкой для проведения
                    Всероссийского форума развития гражданского общества «Добрино» – 2026. Это масштабное
                    событие соберет активистов, волонтеров и лидеров некоммерческих организаций.
                  </p>

                  <h3 className="text-2xl font-bold mt-8 mb-4">Что тебя ждет?</h3>
                  <p>— обмен опытом в сфере развития гражданского общества;</p>
                  <p>— мастер-классы по социальному проектированию;</p>
                  <p>— встречи с экспертами в области НКО;</p>
                  <p>— разработка проектов для развития добровольчества.</p>

                  <p className="bg-[#FCF1F5] border-l-4 border-[#E55C94] p-6 rounded-lg mt-8">
                    <strong>«Добрино»</strong> – это уникальная платформа для тех, кто хочет изменить мир к лучшему.
                    Здесь вы найдете поддержку, вдохновение и новых друзей, разделяющих ваши ценности.
                  </p>
                  ...
                  <p>
                    Для иностранных участников проезд от места проживания до места проведения мероприятия и обратно
                    осуществляется за свой счёт или за счёт направляющей стороны.
                  </p>
                </div>
              </section>
            ...
            <div>
              <div className="bg-[#F5EDE7] rounded-2xl p-6 sticky top-6">
                ...
                <p className="text-sm mb-6">01.07.2026 – 14.07.2026</p>

                <h3 className="font-bold text-base mb-3">Даты регистрации</h3>
                <p className="text-sm mb-6">01.04.2026 – 15.06.2026</p>

                <h3 className="font-bold text-base mb-3">Регион</h3>
                <p className="text-sm mb-6">Россия, Ханты-Мансийский автономный округ - Югра</p>
