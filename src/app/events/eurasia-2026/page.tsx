...
export default function EurasiaEventPage() {
  return (
            ...
            <div className="grid lg:grid-cols-[1fr,400px] gap-12 items-start">
              <div className="text-white">
                <div className="flex items-center gap-2 text-sm mb-2">
                  ...
                  <span>23.06.2026 – 28.06.2026</span>
                </div>
                <div className="flex items-center gap-2 text-sm mb-8">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span>Россия, Оренбургская область</span>
                </div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-8 leading-tight">
                  Международный молодёжный форум «Евразия Global»
                </h1>
                <Button className="bg-[#00A86B] hover:bg-[#008F5A] text-white rounded-full px-10 py-6 text-base font-semibold shadow-lg">
                  Подать заявку
                </Button>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl flex items-center justify-center">
                <div className="text-center">
                  <h2 className="text-4xl font-black">Евразия</h2>
                  <h3 className="text-2xl font-bold text-green-600">Global</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr,380px] gap-12">
            <div>
              <section className="mb-16">
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-gray-700">
                  <p>
                    Международный молодёжный форум «Евразия Global» объединяет молодых лидеров из разных стран.
                  </p>
                </div>
              </section>
            </div>
            ...
            <div>
              <div className="bg-[#F5EDE7] rounded-2xl p-6 sticky top-6">
                ...
                <p className="text-sm mb-6">23.06.2026 – 28.06.2026</p>

                <h3 className="font-bold text-base mb-3">Регион</h3>
                <p className="text-sm mb-6">Россия, Оренбургская область</p>
