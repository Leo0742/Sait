...
export default function SheregeshEventPage() {
  return (
            ...
            <div className="grid lg:grid-cols-[1fr,400px] gap-12 items-start">
              <div className="text-white">
                <div className="flex items-center gap-2 text-sm mb-2">
                  ...
                  <span>22.06.2026 – 25.06.2026</span>
                </div>
                <div className="flex items-center gap-2 text-sm mb-8">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span>Россия, Кемеровская область</span>
                </div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-8 leading-tight">
                  Молодёжный форум «Шерегеш» – 2026
                </h1>
          ...
          <div className="grid lg:grid-cols-[1fr,380px] gap-12">
            ...
            <div>
              <section className="mb-16">
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-gray-700">
                  <p>
                    С 22 по 25 июня Кемеровская область станет местом проведения молодёжного форума «Шерегеш» – 2026.
                    Это уникальная возможность для молодых людей собраться вместе, обменяться идеями и развить
                    свои навыки в различных областях.
                  </p>

                  <h3 className="text-2xl font-bold mt-8 mb-4">Что тебя ждет?</h3>
                  <p>— встречи с экспертами и лидерами мнений;</p>
                  <p>— развитие лидерских качеств и soft skills;</p>
                  <p>— нетворкинг с единомышленниками со всей страны;</p>
                  <p>— практические мастер-классы и воркшопы.</p>
            ...
            <div>
              <div className="bg-[#F5EDE7] rounded-2xl p-6 sticky top-6">
                ...
                <p className="text-sm mb-6">22.06.2026 – 25.06.2026</p>

                <h3 className="font-bold text-base mb-3">Даты регистрации</h3>
                <p className="text-sm mb-6">01.03.2026 – 15.05.2026</p>

                <h3 className="font-bold text-base mb-3">Регион</h3>
                <p className="text-sm mb-6">Россия, Кемеровская область</p>

                <h3 className="font-bold text-base mb-3">Возраст участников</h3>
                <p className="text-sm mb-6">18–30</p>
